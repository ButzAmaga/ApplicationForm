...
export const STEPS: StepMeta[] = [
  ...
  { id: 9, label: "Image Docs",    icon: "✅", description: "Other information"        },
  { id: 10, label: "Declaration",    icon: "✅", description: "Other information"        },
  { id: 11, label: "Policy",    icon: "✅", description: "Other information"        },
